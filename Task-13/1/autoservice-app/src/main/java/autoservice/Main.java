...
public class Main {
    ...
    private static DIContext createAndConfigureDIContext() {
        ...
        di.registerImplementation(MasterRepository.class,
                autoservice.repository.impl.JpaMasterRepository.class);
        di.registerImplementation(WorkshopPlaceRepository.class,
                autoservice.repository.impl.JpaWorkshopPlaceRepository.class);
        di.registerImplementation(autoservice.repository.OrderRepository.class,
                autoservice.repository.impl.JpaOrderRepository.class);
