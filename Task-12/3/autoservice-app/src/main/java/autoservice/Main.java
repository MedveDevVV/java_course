...
import autoservice.repository.impl.DatabaseOrderRepository;
import autoservice.repository.impl.DatabaseWorkshopPlaceRepository;
...
public class Main {
    ...
    private static DIContext createAndConfigureDIContext() {
        ...
        di.registerImplementation(MasterRepository.class, autoservice.repository.impl.DatabaseMasterRepository.class);
